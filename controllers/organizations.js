...
router.post('/create', function(req, res, next) {
    ...
    if(!inputError) {
        ...
        res.render('create_organization', { errorMessage: validatedInputs.error.message });
    }
});
...
////Render the organization's home page
//var renderOrganization = function(err, orgData) {
//    if(!err) {
//        res.render('organization', orgData);
//    }
//    else {
//        res.render('organization', { errorMessage: err.message });
//    }
//}
